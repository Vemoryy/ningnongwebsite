...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="index id.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Bahasa🌐</a>
                        <ul class="dropdown-menu">
    ...
    <section class="hero">
        ...
        <div class="container hero-content">
            ...
            <a href="products id.php" class="btn btn-primary mt-3">Pesan Sekarang</a>
        </div>
    </section>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            <div class="text-box">
                <h1 class="title">Visi & Misi Kami!</h1>
                <p> Memajukan dan memberdayakan perempuan dalam sektor perekonomian keluarga dan bangsa, serta menghidupkan kembali warisan kuliner tradisional agar dikenal dan dicintai oleh generasi muda.</p> <br>
                <ul class="mt-3">
            <li>Terus berinovasi dan meningkatkan kualitas produk untuk menghadirkan makanan tradisional yang tetap relevan dengan selera masa kini.</li><br>
            <li>Menyediakan produk yang mengutamakan kepuasan pelanggan, dengan menjaga keaslian rasa sambil memperkenalkan kue jadoel kepada anak muda.</li><br>
            <li>Memberikan dampak positif pada pemberdayaan perempuan melalui peluang ekonomi yang berkelanjutan dalam industri makanan.</li>
        </ul>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <img src="Image/kembang.jpg" alt="Kembang Goyang" class="image-fluid rounded-image">
        </div>
    </div>
</div>
            ...
            <div id="productCarousel" class="carousel slide mt-4" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <h5>Rasa Kopi</h5>
                            <p>Rasa kopi untuk kerenyahan yang sempurna.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <h5>Rasa Cokelat</h5>
                            <p>Rasa cokelat yang kaya di lidah.</p>
                        </div>
                    </div>
                </div>
