        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="product-coffee id.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Bahasa🌐</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="product-coffee.php">🇬🇧 EN</a></li>
                            <li><a class="dropdown-item" href="product-coffee id.php">🇮🇩 ID</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<section class="container my-5 product-section">
    <div class="row">
        ...
        <div class="col-md-6">
            <h2><b>Ningnong Kembang Goyang – Kopi</b></h2>
            <h3>Deskripsi</h3>
            <p>Diresapi dengan cita rasa kopi yang kaya, camilan renyah ini sangat cocok bagi para pencinta kopi yang mencari camilan unik.</p>
