        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="product-chocolate id.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Bahasa🌐</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="product-chocolate.php">🇬🇧 EN</a></li>
                            <li><a class="dropdown-item" href="product-chocolate id.php">🇮🇩 ID</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <section class="container my-5 product-section">
        <div class="row">
            ...
            <div class="col-md-6 product-description">
                <h2><b>Ningnong Kembang Goyang – Cokelat</b></h2>
                <h3>Deskripsi</h3>
                <p>Bagi yang suka rasa manis, Kembang Goyang rasa cokelat menawarkan cita rasa cokelat yang lembut dan kaya, sempurna untuk memuaskan keinginan ngemil cokelat Anda.</p>
                <h4>Harga: Rp. 30,000</h4>
                <h5>Berat Bersih: 65g</h5>
                <a href="http://shopee.co.id/kembanggoyangningnong" class="btn btn-primary">Pesan Sekarang</a>
            </div>
        </div>
    </section>
